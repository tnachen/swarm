...
func NewNode(addr string, overcommitRatio float64, offer *mesosproto.Offer) *node {
	e := &node{
		addr:            addr,
...
func (n *node) addOffer(offer *mesosproto.Offer) {
...
func (n *node) create(driver *mesosscheduler.MesosSchedulerDriver, config *dockerclient.ContainerConfig, name string, pullImage bool) (*cluster.Container, error) {
